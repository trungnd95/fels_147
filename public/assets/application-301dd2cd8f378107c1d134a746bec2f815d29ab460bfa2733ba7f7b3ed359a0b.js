...
(function() {
  $(document).ready(function() {
    return $('.submit_category').click(function() {
      return $('#addCategory').modal('hide');
    });
  });
...
(function() {
  $(document).on('ready page:change', function() {
    ...
    return $('form').on('click', '.remove_fields', function(event) {
      ...
      return $(this).parent().effect('highlight').fadeOut();
    });
  });
...
(function() {
  $(document).on('ready page:change', function() {
    ...
    return cancel_function = function() {
...
(function() {
  $(document).on('ready page:change', function() {
    $('#category_id').change(function() {
      ...
      return $.ajax({
        ...
        success: function(result) {
          ...
          return $('div.pagination').addClass('hidden');
        },
        error: function(err) {
          return alert(err);
        }
    ...
    return $('#form-filter-words').find("input[name='word_type']").on('change', function() {
      var category_id, url, word_type;
